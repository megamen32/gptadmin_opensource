...
HUB_URL      = os.getenv("HUB_URL", "http://localhost:48653")
CTL_TOKEN    = os.getenv("CTL_TOKEN", "secret_for_chatgpt")
ROOTD_URL    = os.getenv("ROOTD_URL", "http://localhost:48652")
ROOTD_TOKEN  = os.getenv("ROOTD_TOKEN", "secret_for_server")
