...
if __name__ == "__main__":
    ...
    parser.add_argument("--key", default="private.pem", help="Path to private key in PEM format")
    parser.add_argument("--out", default="license.json", help="Output license file path")
