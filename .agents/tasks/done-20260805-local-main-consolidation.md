...
`/home/admin/gptadmin` находится на `main`, содержит все одобренные изменения, а устранённые worktree не имеют уникальных незакоммиченных файлов или недостижимых commit.
...
- 2026-08-05: Attached `/home/admin/gptadmin` to local `main`, removed 17 clean noncanonical worktrees, and pruned 3 stale worktree registrations. `git worktree list` now reports only the canonical checkout.
