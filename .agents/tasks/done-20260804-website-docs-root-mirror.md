...
- 2026-08-04: Translator repo fixed separately in `/home/admin/agents-projects/translate` with `protectMarkdown`/`restoreMarkdown` regression tests, but the website pipeline still depends on the exact backend output.
