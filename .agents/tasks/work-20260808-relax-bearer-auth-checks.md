...
- Canonical `your-subdomain.t.became.bezrabotnyi.com/version`: HTTP 200, build 146 / `1b58f74`.
...
- GPTADMIN plugin `shell_exec(uptime)` on `shell:admin-server-100`: completed, returncode 0.
