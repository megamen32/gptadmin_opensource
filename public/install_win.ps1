...
Usage:
  powershell -ExecutionPolicy Bypass -File .\install_win.ps1 -HubUrl https://became.bezrabotnyi.com -ShellmcpToken srv_secret
  powershell -ExecutionPolicy Bypass -Command "irm https://became.bezrabotnyi.com/install_win.ps1 -OutFile $env:TEMP\install_win.ps1; powershell -ExecutionPolicy Bypass -File $env:TEMP\install_win.ps1 -HubUrl https://became.bezrabotnyi.com -ShellmcpToken srv_secret"
...
if (-not $HubUrl) { $HubUrl = 'https://became.bezrabotnyi.com' }
